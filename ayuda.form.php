...
<FIELDSET>
			<legend><h2>AGREGAR AYUDA ECONOMICA</h2></legend>
	<form ACTION="operaciones.php" method="POST" id="ayuda-nueva">			
	<table width="100%">
		...
		<input type='hidden' name="accion" VALUE="REGISTRAR AYUDA">
...
<div id="format" align="center">    
	...
	<input type="checkbox" id="otro"      VALUE="OTRO" /><label>OTRO: </label><br> <input type='text' name="otro" id="otro2" size="25" maxlength="25" readonly>  
		...
		<tr><td COLSPAN="3">
			<input type='submit' value='guardar ayuda' class="btn btn-otro ayuda-nueva">
