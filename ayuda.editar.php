...
<FIELDSET class="formula">
			<legend><h2>EDITAR LA AYUDA ECONOMICA</h2></legend>
	<form ACTION="operaciones.php" method="POST" id="ayuda-editar">			
	<table width="100%">
		...
		<input type='hidden' name="id_ayuda"  VALUE="<?php echo $rs->fields['id_ayuda']; ?>">
		<input type='hidden' name="accion"    VALUE="ACTUALIZAR AYUDA">
...
<div id="format" align="center">    
	...
	<input type="checkbox" id="otro"      VALUE="OTRO"                           <?php if ($rs->fields['documento7']!='') echo "CHECKED"; ?> /><label>OTRO: </label><br> <input type='text' name="otro" id="otro2" size="25" maxlength="25" VALUE="<?php echo $rs->fields['documento7']; ?>">  
		...
		<tr><td COLSPAN="3">
			<input type='submit' value='guardar ayuda' class="btn btn-otro ayuda-editar">
