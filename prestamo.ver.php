...
<div id="contenido">
<FIELDSET>
			<legend><h2>DETALLES DEL PRESTAMO</h2></legend>
...
</table></form> <?PHP } else echo "<br><br><span class='fallida'>no resultados para el criterio introducido".$db->ErrorMsg()."</span>";
